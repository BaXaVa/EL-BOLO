...
def segundo_apilar():
        ...
        #girar_rad(4,1)
        posicionar_garra_desde_cero()
        movimiento_recto(right_motor,left_motor,14)#esta de frente al bloque rojo 2
        wait(100)
        ...
        robot.stop()
        #girar_rad(4,1)
        movimiento_recto(right_motor, left_motor,7.5)
        robot.turn(-90)
        robot.stop()
        #girar_rad(4)
        movimiento_recto(right_motor, left_motor,0.4)
